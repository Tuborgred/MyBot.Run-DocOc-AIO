...
Global $aTabControlsMod[6] = [$hGUI_MOD_TAB, $hGUI_MOD_TAB_ITEM1, $hGUI_MOD_TAB_ITEM2, $hGUI_MOD_TAB_ITEM3]
...
Func Bind_ImageList($nCtrl)
	...
	Switch $nCtrl
		...
		Case $hGUI_UPGRADE_TAB
			...
			Local $aIconIndex[4] = [$eIcnLaboratory, $eIcnMortar, $eIcnWall, $eIcnUpgrade]
